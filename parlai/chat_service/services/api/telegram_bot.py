...
from parlai.chat_service.services.api.config import PARLAI_PORT, PARLAI_URL
...
parser.add_argument('--api_hostname', default=PARLAI_URL, help="ParlAI API hostname.")
parser.add_argument('--api_port', type=int, default=PARLAI_PORT, help="ParlAI API port.")
